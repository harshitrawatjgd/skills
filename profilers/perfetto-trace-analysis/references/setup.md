...
binary and Python client (the rest of the guidelines assume you then have a
...
[`sql.md`](sql.md) guidelines recommends starting
...
- **The environment has its own packaging story** (Google internal,
  ...
  to that. These guidelines are the OSS default, not a mandate.
